...
from main.views import show_main, add_product, show_product_detail, edit_product, delete_product, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user
